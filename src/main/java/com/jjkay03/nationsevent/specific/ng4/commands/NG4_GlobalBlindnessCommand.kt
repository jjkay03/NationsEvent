...
class NG4_GlobalBlindnessCommand : CommandExecutor, TabCompleter {
    ...
    private fun enableGlobalBlindness(sender: CommandSender) {
        ...
        for (player in Bukkit.getOnlinePlayers()) {
            ...
            if (player.hasPermission(Saves.PERM_STAFF) || player.hasPermission(NG4_SeasonSpecific.PERM_GROUP_WEREWOLF)) continue
