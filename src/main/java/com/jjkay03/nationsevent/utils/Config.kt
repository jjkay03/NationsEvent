...
class Config {
    companion object {
        ...
        val FEATURES_WORLDS_TIME_SYNC_ENABLE = NationsEvent.INSTANCE.config.getBoolean("features.worlds-time-sync.enable", false)
        val FEATURES_WORLDS_TIME_SYNC_WORLDS = NationsEvent.INSTANCE.config.getStringList("features.worlds-time-sync.worlds")
